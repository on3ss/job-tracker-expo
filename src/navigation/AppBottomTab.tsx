    ...
    return (
        <Tab.Navigator>
            <Tab.Screen name="DashboardStack" component={DashboardStack} options={{
                title: "Dashboard",
                tabBarIcon: ({ color }) => <Feather name="compass" color={color} size={24} />
            }} />
            <Tab.Screen name="ScheduleStack" component={ScheduleStack} options={{
                title: "Schedule",
                tabBarIcon: ({ color }) => <Feather name="calendar" color={color} size={24} />
            }} />
            <Tab.Screen name="ApplicationsStack" component={ApplicationsStack} options={{
                title: "Applications",
