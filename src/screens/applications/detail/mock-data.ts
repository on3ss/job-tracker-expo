    ...
    data: [
      {
        ...
        description:
          "An introductory course on programming concepts using Python.",
      ...
      },
      {
        ...
        description:
          "A deep dive into advanced algorithmic techniques and data structures.",
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        description:
          "Learning the basics of web development including HTML, CSS, and JavaScript.",
